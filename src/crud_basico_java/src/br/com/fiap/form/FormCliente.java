...
public class FormCliente extends javax.swing.JFrame {
    ...
    private Cliente pegarCampos() {
        ...
        try {
            ...
            if (fone.equals("") || fone.equals("(__)____-_____")) {
                JOptionPane.showMessageDialog(this, "Digite seu telefone");
                validar = false;
            }
            
            if (dtNasc.equals("") || dtNasc.equals("__/__/____")) {
                JOptionPane.showMessageDialog(this, "Digite sua data de nascimento");
                validar = false;
            }
            
            if (caminho.equals("") || caminho.equals(null)) {
                JOptionPane.showMessageDialog(this, "Selecione uma foto");
                validar = false;
            }
            
            if (validar) {
                 SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
                 Date dataNascimento = new Date(formato.parse(dtNasc).getTime());
    ...
    private void atualizarTabela(){
        ...
        Cliente cliente;
        SimpleDateFormat formato = new SimpleDateFormat("dd/MM/yyyy");
        String[] colunas = {"Nome", "Endereço", "Dt. Nascimento", "Fone"};
